...
async def start_Exiled():
    ...
    if smex:
        ...
        try:
            ...
            await idk(functions.channels.JoinChannelRequest(channel="@OfficialExiled"))
            await idk(functions.channels.JoinChannelRequest(channel="@OfficialExiledSupport"))
    ...
    if smexx:
        ...
        try:
            ...
            await ydk.start()
            await ydk(functions.channels.JoinChannelRequest(channel="@OfficialExiled"))
            await ydk(functions.channels.JoinChannelRequest(channel="@OfficialExiledSupport"))
    ...
    if smexxx:
        ...
        try:
            ...
            await  wdk.start()
            await wdk(functions.channels.JoinChannelRequest(channel="@OfficialExiled"))
            await wdk(functions.channels.JoinChannelRequest(channel="@OfficialExiledSupport"))
    ...
    if smexxxx:
        ...
        try:
            ...
            await hdk.start()
            await hdk(functions.channels.JoinChannelRequest(channel="@OfficialExiled"))
            await hdk(functions.channels.JoinChannelRequest(channel="@OfficialExiledSupport"))
    ...
    if smexxxxx:
        ...
        try:
            ...
            await sdk.start()
            await sdk(functions.channels.JoinChannelRequest(channel="@OfficialExiled"))
            await sdk(functions.channels.JoinChannelRequest(channel="@OfficialExiledSupport"))
    ...
    if sixth:
        ...
        try:
            ...
            await adk.start()
            await adk(functions.channels.JoinChannelRequest(channel="@OfficialExiled"))
            await adk(functions.channels.JoinChannelRequest(channel="@OfficialExiledSupport"))
    ...
    if seven:
        ...
        try:
            ...
            await bdk.start()
            await bdk(functions.channels.JoinChannelRequest(channel="@OfficialExiled"))
            await bdk(functions.channels.JoinChannelRequest(channel="@OfficialExiledSupport"))
    ...
    if eight:
        ...
        try:
            ...
            await cdk.start()
            await cdk(functions.channels.JoinChannelRequest(channel="@OfficialExiled"))
            await cdk(functions.channels.JoinChannelRequest(channel="@OfficialExiledSupport"))
    ...
    if ninth:
        ...
        try:
            ...
            await ddk.start()
            await ddk(functions.channels.JoinChannelRequest(channel="@OfficialExiled"))
            await ddk(functions.channels.JoinChannelRequest(channel="@OfficialExiledSupport"))
    ...
    if tenth:
        ...
        try:
            ...
            await edk.start()
            await edk(functions.channels.JoinChannelRequest(channel="@OfficialExiled"))
            await edk(functions.channels.JoinChannelRequest(channel="@OfficialExiledSupport"))
...
loop.run_until_complete(start_Exiled())       
...
async def _(e):
    ...
    if e.sender_id in SMEX_USERS:
        Exiled = ("".join(e.text.split(maxsplit=1)[1:])).split(" ", 1)     
        if len(e.text) > 5:
            bio = str(Exiled[0])
            text = "Changing Bio"
...
async def spam(e):
    ...
    if e.sender_id in SMEX_USERS:
        ...
        if len(Exiled) == 2:
            message = str(Exiled[1])
            counter = int(Exiled[0])
            if counter > 100:
...
async def spam(e):
    ...
    if e.sender_id in SMEX_USERS:
        if e.text[0].isalpha() and e.text[0] in ("/", "#", "@", "!"):
            return await e.reply(usage, parse_mode=None, link_preview=None )
        smex = await e.get_reply_message()
        Exiled = "".join(e.text.split(maxsplit=1)[1:]).split(" ", 2)
        Exiledsexy = Exiled[1:]
        if len(Exiledsexy) == 2:
            message = str(Exiledsexy[1])
            counter = int(Exiledsexy[0])
            sleeptime = float(Exiled[0])
            for _ in range(counter):
...
print(text)
print("")
print("SMEX! Exiled Multi Spam Bot Started Sucessfully.")
